...
export default function Home() {
  ...
  const handleSlotSelect = (slot: Slot) => {
    ...
    setValue('serviceId', 1) // Default to first service
  }
        ...
        {selectedDate && (
          <div className="bg-white p-6 rounded-lg shadow-lg mb-6" style={{ boxShadow: '0 4px 20px rgba(205, 162, 145, 0.15)' }}>
            ...
            {loading ? (
              ...
              <p>No hay horarios disponibles para esta fecha. (Recibidos: {availableSlots.length} slots) Debug: {JSON.stringify(availableSlots)}</p>
            ) : (
